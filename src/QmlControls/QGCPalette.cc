...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonBorder,         "#9d9d9d", "#87CEEB", "#707070", "#87CEEB")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#333333", "#A6A6A6", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#87CEEB", "#3a3a3a", "#87CEEB")
    DECLARE_QGC_COLOR(buttonHighlightText,  "#2c2c2c", "#ffffff", "#2c2c2c", "#ffffff")
    DECLARE_QGC_COLOR(primaryButton,        "#585858", "#87CEEB", "#585858", "#87CEEB")
    ...
    DECLARE_QGC_COLOR(colorBlue,            "#87CEEB", "#87CEEB", "#87CEEB", "#87CEEB")
    ...
    DECLARE_QGC_COLOR(groupBorder,          "#bbbbbb", "#87CEEB", "#707070", "#87CEEB")

    // Colors not affecting by theming
    //                                                      Disabled     Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,             "#4A2C6D", "#4A2C6D")
    DECLARE_QGC_NONTHEMED_COLOR(brandingBlue,               "#87CEEB", "#87CEEB")
