...
# ----------------------------------------------------------------------------
# Application Branding (pdlGCS / TZX)
# ----------------------------------------------------------------------------
set(QGC_APP_NAME        "pdlGCS"                           CACHE STRING "App Name"        FORCE)
set(QGC_ORG_NAME        "TZX"                              CACHE STRING "Organization"    FORCE)
set(QGC_ORG_DOMAIN      "tzx.local"                        CACHE STRING "Domain"          FORCE)
set(QGC_PACKAGE_NAME    "com.tzx.pdlgcs"                   CACHE STRING "Package id"      FORCE)
set(QGC_APP_DESCRIPTION "pdlGCS Ground Control Station"    CACHE STRING "Description"     FORCE)
string(TIMESTAMP _pdl_year "%Y")
set(QGC_APP_COPYRIGHT   "Copyright (c) ${_pdl_year} TZX. All rights reserved." CACHE STRING "Copyright" FORCE)
